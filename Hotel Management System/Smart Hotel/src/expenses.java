   ...
   ResultSet rs=null;
    ...
    public ArrayList<classExpens> expensList()
    {
       ...
       try{
           ...
           classExpens expens;
           while(rs.next()){
               expens = new classExpens(rs.getInt("id"),rs.getString("name"),rs.getString("nature"),rs.getFloat("expens"));
            ...
            .addGroup(backgroundLayout.createSequentialGroup()
                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(backgroundLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtsearch, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
                    .addGroup(backgroundLayout.createSequentialGroup()
                        .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(backgroundLayout.createSequentialGroup()
                                .addGap(209, 209, 209)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            conn=mySqlConnection.ConnectDB();
            String qry="INSERT into expenses(name, nature, expens,  )VALUES(?,?,?)";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            conn=mySqlConnection.ConnectDB();
            String str="update expenses set name=?, nature=?, expens=?, where id=?";
