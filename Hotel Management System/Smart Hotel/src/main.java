...
public class main extends javax.swing.JFrame {
    ...
    public ArrayList<ClassCheckOut> dataList2()
   {
       ...
       try{
           ...
           ClassCheckOut Data;
           while(rs.next()){
               Data = new ClassCheckOut(rs.getInt("id"),rs.getString("cus_name"),rs.getString("cus_father"),rs.getString("address"),rs.getLong("cus_nic"), rs.getLong("phone"),rs.getInt("cus_adult"),rs.getInt("cus_child"),rs.getInt("room_no"),rs.getFloat("room_cost"),rs.getFloat("taxes"),rs.getFloat("total"));
        ...
        sidebarLayout.setHorizontalGroup(
            ...
            .addGroup(sidebarLayout.createSequentialGroup()
                ...
                .addGroup(sidebarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnExpens, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btn_print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_print1ActionPerformed
        ...
        MessageFormat header = new MessageFormat("heckOUT Records ");
        MessageFormat footer = new MessageFormat("software Generated Record");
        try{
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
        ...
        MessageFormat header = new MessageFormat("CheckIN Records ");
        MessageFormat footer = new MessageFormat("Software Generated Record");
        try{
